          ...
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm space-y-2 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs sm:text-sm">+254 720799363</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4" />
                <span className="text-xs sm:text-sm">filterskenyaltd@gmail.com</span>
              </div>
            </div>
            <div className="hidden sm:block">
              <span className="text-xs sm:text-sm">Reliable Filtration Solutions Since 2020</span>
            </div>
          </div>
        </div>
      </div>
